...
function App() {
  return (
    <div className="App">
      {
        heroes.map((hero) =>
          <Hero name={hero.name} universe={hero.universe} altername={hero.altername} occupation={hero.occupation} friends={hero.friends}superpowers={hero.superpowers} longtext={hero.longtext} picture={hero.picture}></Hero>
        )
      }
    </div>
  );
